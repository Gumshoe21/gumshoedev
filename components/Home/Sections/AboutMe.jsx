		...
		<Flex direction="column" py={20}>
			...
			>
				...
				>
					...
					>
						<Text>
							I was born in Los Angeles&#44; California and moved to Israel with
							my family at a very young age (!כן, אני מדבר עברית). I then moved
							back to the United States in late childhood&#44; where I&apos;ve
							been living ever since.
						</Text>
						<br></br>
						<Text>
							I&apos;ve always had an affinity for technology. When I was 4
							years old&#44; my parents purchased a Windows 3.1 PC&#44; and I
							was immediately hooked.
						</Text>
						<br></br>
						<Text>
							I graduated from the University of California&#44; Los Angeles
							(UCLA) in 2014 with a Bachelor of Arts degree in English Language
							and Literature. I&apos;ve always been a big reader and enjoy
							writing from time to time (check out my{' '}
