...
import thumbnailTwitch from "@public/twitch.png";
			...
			<Flex id="projects" direction="column" py={32}>
				...
				>
					...
					<Flex direction="column" align="center" justify="center" gap="4.8rem">
						...
						>
							<Text>
								A&nbsp;<strong>Pomodoro timer app</strong>&nbsp; aimed at
								boosting productivity. The app generates reports based on your
								study habits, and gives you an idea of how much studying
								you&apos;re doing over time. The app was inspired by the
								&quot;study with me&quot; trend of videos on YouTube, which
								often feature an on-screen Pomodoro timer.
							</Text>
							<Text
								as="i"
								fontWeight="500"
							...
							>
								Built with Next.js, Express.js, MongoDB, React.js, Nivo, and
								Chakra UI.
							</Text>
						</Project>
						{/* End Project 1 */}
						...
						>
							<Text>
								A&nbsp;<strong>word game</strong>&nbsp;that challenges users to
								form as many heterograms as possible before running out of time.
								Allows for OAuth 2 login via Google and GitHub. Features a
							...
							<Text
								...
								fontSize="md"
							>
								Built with Next.js, NextAuth, Prisma, PostgreSQL, and Tailwind
								CSS/UI.
							</Text>
						</Project>
						{/* End project 2 */}
						...
						{/* Project 4 */}
						<Project
							githubHref={"https://github.com/Gumshoe21/FatYoshiBot"}
							title="Twitch Bot"
							href="https://github.com/Gumshoe21/FatYoshiBot"
							thumbnailSrc={thumbnailTwitch}
							type="even"
						>
							<Text>
