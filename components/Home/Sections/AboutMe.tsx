				...
				<Flex direction='column' gap={10} bg={heroBgColor} transitionDuration='200ms'>
					...
					>
						<Flex gap={4} textAlign='center' direction='column' fontSize='lg'>
							<Text>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;I was born in Los Angeles&#44; California and moved to
								Israel with my family at a very young age. I then moved back to the United States in late childhood&#44;
								where I&apos;ve been living ever since.
							</Text>
							<Text>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;I&apos;ve always had an interest in technology. When I
								was 4 years old&#44; my parents purchased a computer running Microsoft Windows 3.1 PC&#44; and I was
								immediately hooked.
							</Text>
							<Text>
